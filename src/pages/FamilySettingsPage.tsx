...
const SettingsPage: React.FC = () => {
  ...
  const handleCreateFamily = async () => {
    ...
    try {
      ...
      // ユーザープロフィールを更新（実際には UserService で実装が必要）
      await refreshFamily();
  ...
  const renderFamilyManagement = () => {
      ...
      return (
        <div className="bg-blue-50 border border-blue-200 p-6 rounded-xl">
          ...
          <p className="text-blue-700 mb-4">
            家族でおたよりを共有するには、スタンダードプラン以上が必要です。
          </p>
    ...
    return (
      <div className="space-y-6">
        ...
        {/* お子さま管理 */}
        <div className="bg-white p-6 rounded-xl shadow-md">
          <h2 className="text-xl font-bold text-gray-800 mb-4">お子さま</h2>
          ...
          {showAddChild ? (
            <div className="p-4 bg-orange-50 rounded-lg space-y-4">
              <h3 className="font-bold text-lg text-gray-800">お子さまの追加</h3>
